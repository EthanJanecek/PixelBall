...
function playbook:createPlaybook()
    ...
    return setmetatable({
        ...
        defensePlays={
            DefenseLib:createManDefense(5),
            DefenseLib:createManDefense(5),
            DefenseLib:createManDefense(4), 
            DefenseLib:createManDefense(4),
            DefenseLib:createManDefense(-1),
            DefenseLib:createZoneDefense(zone122, "1-2-2"),
            DefenseLib:createZoneDefense(zone23, "2-3"),
            DefenseLib:createZoneDefense(zone32, "3-2"),
